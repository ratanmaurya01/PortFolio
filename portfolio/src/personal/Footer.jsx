            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='border-t border-gray-600 pt-4 flex flex-col md:flex-row justify-between items-center'>
                    ...
                    <div className='flex space-x-4 my-4 md:my-0'>
                          ...
                          <a href="https://www.linkedin.com/in/ratan-kumar-maurya-515751159/" className='text-gray-400 hover:text-white'>
                              <FaLinkedin />
                          </a>
                          <a href="https://github.com/ratanmaurya01" className='text-gray-400 hover:text-white'>
                              <FaGithub />
                          </a>
                          <a href="#" className='text-gray-400 hover:text-white'>
                              <FaWhatsapp />
                    ...
                    <div className='flex space-x-4'>
                          ...
                          <a href="#" className='text-gray-400 hover:text-white'>Terms & Policy</a>
                    </div>
                </div>
            </div>
        </footer>
