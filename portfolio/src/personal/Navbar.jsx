...
//                     </button>
//                 </div>
//                 <div className='hidden md:block bg-gradient-to-r from-green-400 to-blue-500 text-white transform transition duration-300 hover:scale-105 px-4 py-2 rounded-full'>Connect Me</div>
//             </div>
//             <div className={`md:flex ${isOpen ? 'flex flex-col items-center mt-2' : 'hidden'} md:space-x-6`}>
